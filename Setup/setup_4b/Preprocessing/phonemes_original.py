...
def __write_phonemes_in_ipa_format(phonemes_ipa):
    with open(join("/IMS-Toucan/Preprocessing", "ipa_phonemes_merged.txt"), mode='w+', encoding='utf8') as output_file:
        output_file.write('\n'.join(phonemes_ipa))
...
def read_phonemes():
    with open(join(".", "ipa_phonemes_merged"), mode='r', encoding='utf8') as input_file:
