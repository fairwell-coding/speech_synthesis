...
def plot_attention(model, lang, device, speaker_embedding, att_dir, step):
    ...
    if lang == "at-lab":
        text = tf.string_to_tensor(sentence, path_to_wavfile="/IMS-Toucan/aridialect/aridialect_wav16000/spo_at_falter060401bis060630_001683.wav").long().squeeze(0).to(device)
        phones = tf.get_phone_string(sentence, path_to_wavfile="/IMS-Toucan/aridialect/aridialect_wav16000/spo_at_falter060401bis060630_001683.wav")
    else:
